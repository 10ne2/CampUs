		...
		<div class="card-body" style="margin-bottom: -25px;">
			...
			<div id="homeworkGrid"
				...
				<div class="jsgrid"
					...
					<div class="jsgrid-body scroll-table-wrapper" style="height: 124px;">
						<table class="jsgrid-table">
							<tbody>
								<c:forEach var="hw" items="${unsubmitList}">
									<tr style="background-color: white;  line-height: 24px;  border-bottom: 1px solid #e0e0e0;
		...
		<div class="card-body"
			...
			<div style="width: 35%; height: 100%; margin-right: 20px">
				...
				<div class="progress progress-sm"
					...
					<div class="progress-bar" style="width: 40%; height: 100%; background-color: #2EC4B6">
						<span style="display: block; width: 100%; height: 5%; text-align: center; font-size: 17px; color:#212121;">40%</span>
					</div>
					<div class="progress-bar" style="width: 30%; height: 100%; background-color: #FFE99A;">
						<span style="display: block; width: 100%; height: 5%; text-align: center; font-size: 17px; color:#212121;">30%</span>
					</div>
					<div class="progress-bar" style="width: 20%; height: 100%; background-color: #EF7C7C">
						<span style="display: block; width: 100%; height: 5%; text-align: center; font-size: 17px; color:#212121;">20%</span>
					</div>
					<div class="progress-bar" style="width: 10%; height: 100%; background-color: #CDCDCD">
						<span style="display: block; width: 100%; height: 5%; text-align: center; font-size: 17px; color:#212121;">10%</span>
					</div>
				</div>
							...
							<tbody>
								<c:forEach var="att" items="${attendenceList}">
									<tr class="jsgrid-row">
										...
										<td class="atten jsgrid-cell jsgrid-align-center"
											style="width: 20%;">${att.attendanceStatus }</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
